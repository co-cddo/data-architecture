...
if __name__ == '__main__':
    print(os.getcwd())
    replaceInFiles(r"/home/runner/work/data-architecture/data-architecture",
                   r"/home/runner/work/data-architecture/data-architecture/**/*.puml",
                   "([!]include\w{0,3}\s+?)([^<:]+?\n)",
                   "https://raw.githubusercontent.com/co-cddo/data-architecture/main/")
